...
`;let r=class extends l{render(){return i`
      <ewt-dialog
        open
        heading="Ningún puerto seleccionado"
        scrimClickAction
      ...
      >
        ...
        <ol>
          <li>
            Asegúrese de que el dispositivo esté conectado a esta computadora (el único
          ...
          <li>
            La mayoría de los dispositivos tienen una pequeña luz cuando están encendidos. si el tuyo tiene
             uno, asegúrese de que esté encendido.
          </li>
          <li>
            Asegúrese de que el cable USB que utiliza pueda usarse para datos y no sea
             un cable solo de alimentación.
          </li>
          <li>
            Asegúrese de tener instalados los controladores correctos. A continuación se muestran los
             Controladores para chips comunes utilizados en dispositivos ESP:
            <ul>
              <li>
                CP2102 drivers:
                <a
